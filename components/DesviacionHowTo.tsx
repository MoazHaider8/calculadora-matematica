const steps = [
  ...
  { n: '3', text: 'Pulsa calcular desviación estándar.' },
  { n: '4', text: 'Revisa la media, la varianza y el resultado principal.' },
  { n: '5', text: 'Interpreta la dispersión de los datos respecto a la media.' },
];

export function DesviacionHowTo() {
  return (
    <section className="bg-white py-12 lg:py-16" aria-labelledby="howto-desv-heading">
      <div className="site-shell">
        <p className="eyebrow">Guía de uso</p>
        <h2 id="howto-desv-heading" className="mt-2 mb-8 text-[1.5rem] font-bold text-ink lg:text-[1.8rem]">
