...
export function ArticuloDetsArtHero() {
  return (
      ...
      <div className="site-shell">
        <nav aria-label="Ruta de navegación" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/70">
            ...
            <li aria-hidden="true" className="text-white/40">/</li>
            <li className="text-white/90">Cómo calcular determinantes</li>
          </ol>
        </nav>
        ...
        <div className="mt-5 flex flex-wrap items-center gap-4">
          <div className="flex flex-wrap gap-2">
            {['Determinante 2×2', 'Determinante 3×3', 'Regla de Sarrus', 'Determinante cero'].map(chip => (
              <span
                key={chip}
        ...
        <div className="mt-7">
          ...
          >
            Calculadora de determinantes &rarr;
          </Link>
        </div>
      </div>
    </section>
