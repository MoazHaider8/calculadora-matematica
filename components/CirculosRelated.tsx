...
export function CirculosRelated() {
  return (
    <section className="bg-white py-12 lg:py-16" aria-labelledby="related-circ-heading">
      <div className="site-shell">
        <p className="eyebrow">Recursos</p>
        <h2 id="related-circ-heading" className="mt-2 mb-8 text-[1.5rem] font-bold text-ink lg:text-[1.8rem]">
