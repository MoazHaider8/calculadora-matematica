...
export function AlgebraicaHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora algebraica">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora Algebraica</li>
          </ol>
        </nav>
        ...
        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Simplifica expresiones algebraicas, expande paréntesis, factoriza expresiones básicas y evalúa una expresión con un valor de variable.
        </p>
