...
const chips = ['det(A)', 'Matriz 2x2', 'Matriz 3x3', 'Matriz 4x4', 'Matriz singular'];

const stats = [
  { value: '3',    label: 'tamaños comunes'    },
  { value: '5',    label: 'ejemplos resueltos' },
  { value: '100%', label: 'contenido en español' },
];

export function DeterminanteHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de determinantes">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Determinantes</li>
          </ol>
        </nav>
        ...
        >
          ...
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>ad - bc</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>Sarrus</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>det(I) = 1</span>
        </div>
