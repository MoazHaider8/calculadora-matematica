...
export function ArticuloPolinomiosHero() {
  return (
      ...
      <div className="site-shell">
        <nav aria-label="Ruta de navegación" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/70">
            ...
            <li aria-hidden="true" className="text-white/40">/</li>
            <li className="text-white/90">Qué son los polinomios</li>
          </ol>
        </nav>
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/80">
          Un polinomio es una expresión algebraica formada por la suma de términos con variables elevadas a potencias enteras no negativas.
        </p>

        <div className="mt-5 flex flex-wrap items-center gap-4">
          <div className="flex flex-wrap gap-2">
            {['Grado del polinomio', 'Operaciones básicas', 'Raíces', 'Factorización'].map(chip => (
              <span
                key={chip}
        ...
        <div className="mt-7">
          ...
          >
            Calculadora de polinomios &rarr;
          </Link>
        </div>
      </div>
    </section>
