...
const chips = ['Directa', 'Inversa', 'Proporciones', 'Producto cruzado', 'Valor X'];
const stats = [
  { value: '2',    label: 'tipos de cálculo'       },
  { value: '5',    label: 'ejemplos resueltos'       },
  { value: '100%', label: 'contenido en español'     },
];

export function ReglaTresHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de regla de tres online">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Regla de Tres</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Calculadora de regla de tres online
        </h1>

        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Resuelve proporciones con regla de tres directa e inversa. Introduce los valores conocidos, encuentra el valor desconocido X, revisa la fórmula y entiende el procedimiento paso a paso.
        </p>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>3 &rarr; 150</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>5 &rarr; X</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>X = 250</span>
        </div>
