...
export function ArticuloCalcCientHero() {
  return (
      ...
      <div className="site-shell">
        <nav aria-label="Ruta de navegación" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/70">
            ...
            <li aria-hidden="true" className="text-white/40">/</li>
            <li className="text-white/90">Cómo usar una calculadora científica</li>
          </ol>
        </nav>
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/80">
          Una calculadora científica va más allá de las cuatro operaciones básicas. Maneja potencias, raíces, logaritmos y funciones trigonométricas, y respeta el orden correcto de las operaciones.
        </p>

        <div className="mt-5 flex flex-wrap items-center gap-4">
          <div className="flex flex-wrap gap-2">
            {['Orden de operaciones', 'Potencias y raíces', 'Logaritmos', 'Trigonometría básica'].map(chip => (
              <span
                key={chip}
