...
const chips = ['Trigonometría', 'Logaritmos', 'Potencias', 'Raíces', 'Grados y radianes'];
const stats = [
  { value: '20+',  label: 'funciones disponibles'   },
  { value: '5',    label: 'ejemplos resueltos'       },
  { value: '100%', label: 'contenido en español'     },
];

export function CientificaHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora científica online">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li>
              <Link href="/calculadoras/aritmetica" className="transition-colors hover:text-white hover:underline underline-offset-2" style={{ color: 'rgba(221,243,240,0.75)' }}>
                Aritmética
              </Link>
            </li>
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora Científica</li>
          </ol>
        </nav>

        <p className="eyebrow" style={{ color: '#D8A31A' }}>Calculadora de aritmética</p>
        ...
        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Resuelve operaciones combinadas, usa funciones trigonométricas como seno, coseno y tangente, calcula logaritmos, raíces y potencias, trabaja con las constantes π y e, y cambia entre grados y radianes según lo necesites.
        </p>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>sin(30)</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>log(100)</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>√144</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>2^3</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>ln(e)</span>
        </div>
