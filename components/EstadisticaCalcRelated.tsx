...
const related = [
  ...
  { name: 'Calculadora de Probabilidad',         desc: 'Calcula probabilidades a partir de casos favorables y posibles.',       url: '/calculadoras/estadistica/calculadora-de-probabilidad',                         live: false },
