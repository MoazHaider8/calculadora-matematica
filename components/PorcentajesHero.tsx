...
const chips = ['Porcentaje', 'Descuento', 'Aumento', 'Cambio porcentual', 'Total'];

const stats = [
  { value: '6',    label: 'cálculos'             },
  { value: '5',    label: 'ejemplos resueltos'   },
  { value: '100%', label: 'contenido en español' },
];

export function PorcentajesHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de porcentajes">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Porcentajes</li>
          </ol>
        </nav>
        ...
        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Calcula porcentajes, descuentos, aumentos, cambio porcentual, qué porcentaje es una cantidad de otra y el total a partir de una parte.
        </p>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>25% de 200</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>200 − 20%</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>80 → 100</span>
        </div>
