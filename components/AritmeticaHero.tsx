...
const quickLinks = [
  { label: 'Fracciones',    anchor: '#herramienta-fracciones'   },
  { label: 'Porcentajes',   anchor: '#herramienta-porcentajes'  },
  { label: 'Científica',    anchor: '#herramienta-cientifica'   },
  { label: 'Promedio',      anchor: '#herramienta-promedio'     },
  { label: 'Regla de tres', anchor: '#herramienta-regla-de-tres' },
];
...
export function AritmeticaHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Aritmética">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Aritmética</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Calculadoras de aritmética online
        </h1>

        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Esta categoría reúne herramientas para trabajar con fracciones, porcentajes, promedio, regla de tres, operaciones básicas y cálculos científicos.
        </p>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>a/b</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>25%</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>x̄</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>a:b = c:x</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>√x</span>
        </div>
