...
const relacionadas = [
  ...
  { name: 'Calculadora de Raíz Cuadrada',    href: '/calculadoras/algebra/calculadora-de-raiz-cuadrada' },
...
export function PitaRelacionadas() {
  return (
    <section className="bg-white-soft py-8 lg:py-10" aria-labelledby="pita-rel-h">
      <div className="site-shell">
        <p className="eyebrow">Más calculadoras</p>
        <h2 id="pita-rel-h" className="mt-2 mb-5 text-[1.5rem] font-bold text-ink lg:text-[1.8rem]">Calculadoras relacionadas</h2>
