...
export function ArticuloPobMuestraHero() {
  return (
      ...
      <div className="site-shell">
        <nav aria-label="Ruta de navegación" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/70">
            ...
            <li aria-hidden="true" className="text-white/40">/</li>
            <li className="text-white/90">Población y muestra en estadística</li>
          </ol>
        </nav>
        ...
        <div className="mt-5 flex flex-wrap items-center gap-4">
          <div className="flex flex-wrap gap-2">
            {['Población estadística', 'Muestra representativa', 'Varianza muestral', 'n vs n−1'].map(chip => (
              <span
                key={chip}
