...
const chips = ['P(A)', 'Complemento', 'Unión', 'Intersección', 'Al menos uno'];
const stats = [
  { value: '5',    label: 'tipos de probabilidad' },
  { value: '5',    label: 'ejemplos resueltos'     },
  { value: '100%', label: 'contenido en español'   },
];

export function ProbabilidadHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de probabilidad online">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li>
              <Link href="/calculadoras/estadistica" className="transition-colors hover:text-white hover:underline underline-offset-2" style={{ color: 'rgba(221,243,240,0.75)' }}>
                Estadística
              </Link>
            </li>
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Probabilidad</li>
          </ol>
        </nav>

        <p className="eyebrow" style={{ color: '#D8A31A' }}>Calculadora de estadística</p>

        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Calculadora de probabilidad online
        </h1>

        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Calcula probabilidades de eventos a partir de casos favorables, complementos, uniones, intersecciones y repeticiones. Resultado en decimal, porcentaje y fracción.
        </p>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>P(A) = f / n</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>P(A&#x2019;) = 1 &minus; P(A)</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>P(A &cup; B)</span>
        </div>
