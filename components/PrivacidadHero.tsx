...
const chips = ['Datos personales', 'Cookies', 'Analítica', 'Formularios', 'Transparencia'];

export function PrivacidadHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Política de Privacidad">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li style={{ color: '#DDF3F0' }}>Política de Privacidad</li>
          </ol>
        </nav>

        <p className="eyebrow" style={{ color: '#D8A31A' }}>Privacidad</p>
        ...
        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Esta página describe cómo Calculadora Matemática puede recopilar, usar y proteger información cuando navegas por el sitio, usas las calculadoras, envías formularios o interactúas con las páginas disponibles.
        </p>
