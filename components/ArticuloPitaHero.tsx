...
const chips = ['a² + b² = c²', 'Hipotenusa', 'Catetos', 'Ejemplos', 'Errores comunes'];

export function ArticuloPitaHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Teorema de Pitágoras explicado con ejemplos">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Teorema de Pitágoras</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Teorema de Pitágoras explicado con ejemplos
        </h1>
        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          El teorema de Pitágoras relaciona los tres lados de un triángulo rectángulo. Este artículo explica la fórmula, cómo calcular la hipotenusa o cualquiera de los catetos, con cinco ejemplos resueltos y los errores más comunes.
        </p>
        ...
        <div className="mt-7">
          <Link href="/calculadoras/geometria/calculadora-de-pitagoras" className="inline-flex items-center gap-2 rounded-lg bg-white px-5 py-2.5 text-sm font-bold text-ink transition-colors hover:bg-gold">
            Usar calculadora de Pitágoras &rarr;
          </Link>
        </div>
      </div>
    </section>
