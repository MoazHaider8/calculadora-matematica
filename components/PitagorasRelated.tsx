...
const related = [
  ...
  { name: 'Calculadora de Círculos',      desc: 'Calcula radio, diámetro, área y circunferencia.',                 url: '/calculadoras/geometria/calculadora-de-circulos',        live: true },
...
export function PitagorasRelated() {
  return (
    <section className="bg-white py-12 lg:py-16" aria-labelledby="related-pit-heading">
      <div className="site-shell">
        <p className="eyebrow">Recursos</p>
        <h2 id="related-pit-heading" className="mt-2 mb-8 text-[1.5rem] font-bold text-ink lg:text-[1.8rem]">
