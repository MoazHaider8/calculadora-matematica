...
const chips = ['Población', 'Muestra', 'Varianza', 'Dispersión', 'Pasos'];
const stats = [
...
export function DesviacionHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de desviación estándar online">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Desviación Estándar</li>
          </ol>
        </nav>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>&sigma; = &radic;(&Sigma;(x &minus; &mu;)&sup2; / n)</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>s = &radic;(&Sigma;(x &minus; x&#x0304;)&sup2; / (n&minus;1))</span>
        </div>
