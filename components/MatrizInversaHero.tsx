...
const chips = ['A⁻¹', 'Matriz 2x2', 'Matriz 3x3', 'Gauss Jordan', 'Matriz singular'];
...
export function MatrizInversaHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de matriz inversa">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Matriz Inversa</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Calculadora de matriz inversa online
        </h1>
        ...
        >
          ...
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>A · A⁻¹ = I</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>det(A) ≠ 0</span>
        </div>
