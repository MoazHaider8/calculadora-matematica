...
const calcs = [
  { href: '/calculadoras/calculo/calculadora-de-integrales', label: 'Calculadora de integrales', desc: 'Resuelve integrales indefinidas y definidas.' },
  { href: '/calculadoras/calculo/calculadora-de-derivadas', label: 'Calculadora de derivadas', desc: 'Calcula derivadas de funciones.' },
  { href: '/calculadoras/calculo/calculadora-de-limites', label: 'Calculadora de límites', desc: 'Evalúa límites de funciones.' },
  { href: '/calculadoras/calculo', label: 'Ver todas las calculadoras de cálculo', desc: 'Derivadas, integrales, límites y más.' },
];

export function IntegralRelacionadas() {
  return (
