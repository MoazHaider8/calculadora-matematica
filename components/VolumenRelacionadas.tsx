...
export function VolumenRelacionadas() {
  return (
    <section className="bg-white py-8 lg:py-10" aria-labelledby="vol-rel-h">
      <div className="site-shell">
        <p className="eyebrow">Más calculadoras</p>
        <h2 id="vol-rel-h" className="mt-2 mb-5 text-[1.5rem] font-bold text-ink lg:text-[1.8rem]">Calculadoras relacionadas</h2>
