...
const chips = ['Media', 'Media aritmética', 'Datos', 'Tendencia central', 'Pasos'];
const stats = [
...
export function MediaHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de media online">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Media</li>
          </ol>
        </nav>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>x&#x0304; = &Sigma;x / n</span>
