...
const chips = ['Sistema 2x2', 'Sistema 3x3', 'Eliminación', 'Matriz aumentada', 'Comprobación'];

const stats = [
  { value: '2',    label: 'tamaños comunes'    },
  { value: '5',    label: 'ejemplos resueltos' },
  { value: '100%', label: 'contenido en español' },
];

export function SistemasHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de sistemas de ecuaciones">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li>
              <Link href="/calculadoras/matrices-y-vectores" className="transition-colors hover:text-white hover:underline underline-offset-2" style={{ color: 'rgba(221,243,240,0.75)' }}>
                Matrices y Vectores
              </Link>
            </li>
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Sistemas de Ecuaciones</li>
          </ol>
        </nav>

        <p className="eyebrow" style={{ color: '#D8A31A' }}>Calculadora de matrices y vectores</p>
        ...
        >
          ...
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>2x2</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>3x3</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
