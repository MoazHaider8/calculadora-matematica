...
const related = [
  {
    ...
    category: 'Cálculo',
    desc: 'Los logaritmos son la operación inversa de los exponentes. Calcula log en base 10, base e y bases personalizadas.',
    href: '/calculadoras/calculo/calculadora-de-logaritmos',
  },
  {
    label: 'Calculadora de Integrales',
    category: 'Cálculo',
    desc: 'Calcula integrales definidas e indefinidas de forma simbólica.',
    href: '/calculadoras/calculo/calculadora-de-integrales',
  },
  {
    label: 'Calculadora de Derivadas',
    category: 'Cálculo',
    desc: 'Calcula la derivada simbólica de una función respecto a una variable.',
  ...
  },
  {
    ...
    category: 'Aritmética',
    desc: 'Operaciones científicas completas incluyendo potencias, raíces y funciones trigonométricas.',
    href: null,
  },
  {
    label: 'Calculadora de Raíz Cuadrada',
    category: 'Álgebra',
    desc: 'Calcula raíces cuadradas y simplifica expresiones con radicales.',
    href: null,
  },
  {
...
export function ExponenteRelated() {
  return (
    <section className="bg-page py-10 lg:py-14" aria-labelledby="related-exp-heading">
      <div className="site-shell">

        <div className="mb-7">
          <p className="eyebrow">Herramientas relacionadas</p>
          <h2 id="related-exp-heading" className="mt-2 text-[1.6rem] font-bold text-ink lg:text-[1.9rem]">
