...
export function ContactoEnlaces() {
  return (
    <section className="bg-white py-12 lg:py-16" aria-labelledby="enlaces-heading">
      <div className="site-shell">
        <p className="eyebrow">Navegación</p>
        <h2 id="enlaces-heading" className="mt-2 mb-8 text-[1.5rem] font-bold text-ink lg:text-[1.8rem]">
          Enlaces útiles
        </h2>
