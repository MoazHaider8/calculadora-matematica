...
export function AvisoIntroEIdentificacion() {
  return (
    <div>
      <section className="bg-white-soft py-8 lg:py-11" aria-labelledby="aviso-intro-heading">
      ...
      <section className="bg-white py-8 lg:py-11" aria-labelledby="identificacion-heading">
        <div className="site-shell">
