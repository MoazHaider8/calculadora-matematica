...
const chips = ['Suma', 'Resta', 'Multiplicación', 'División', 'Simplificación'];
...
export function FraccionesHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de fracciones">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Fracciones</li>
          </ol>
        </nav>
        ...
        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Suma, resta, multiplica, divide y simplifica fracciones. Obtén el resultado simplificado, la fracción mixta, el decimal y los pasos del procedimiento.
        </p>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>1/2 + 3/4</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>2/3 × 3/5</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>12/18 = 2/3</span>
        </div>
