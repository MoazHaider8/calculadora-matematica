...
const calcs = [
  ...
  { href: '/calculadoras/algebra/calculadora-algebraica', label: 'Calculadora algebraica', desc: 'Simplifica y opera con expresiones algebraicas.' },
...
export function EcuaRelacionadas() {
  return (
