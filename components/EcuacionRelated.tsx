...
const related = [
  {
    label: 'Calculadoras de Álgebra',
    category: 'Categoría',
    desc: 'Explora todas las herramientas de álgebra organizadas por tema.',
    href: '/calculadoras/algebra',
  },
  {
    label: 'Calculadoras de Cálculo',
    category: 'Categoría',
  ...
  },
  {
    ...
    category: 'Cálculo',
    desc: 'Calcula potencias y exponentes, incluyendo negativos y fraccionarios.',
    href: '/calculadoras/calculo/calculadora-de-exponentes',
  },
  {
    label: 'Calculadora de Logaritmos',
    category: 'Cálculo',
    desc: 'Los logaritmos son la operación inversa de las ecuaciones exponenciales.',
    href: '/calculadoras/calculo/calculadora-de-logaritmos',
  },
  {
    label: 'Calculadora de Derivadas',
    category: 'Cálculo',
    desc: 'Calcula la derivada de funciones algebraicas y trigonométricas.',
    href: '/calculadoras/calculo/calculadora-de-derivadas',
  },
  {
    label: 'Calculadora Algebraica',
    category: 'Álgebra',
    desc: 'Simplifica y factoriza expresiones algebraicas.',
    href: null,
  },
  {
    label: 'Calculadora de Polinomios',
    category: 'Álgebra',
    desc: 'Opera con polinomios de cualquier grado.',
    href: null,
  },
  {
    label: 'Calculadora de Raíces',
    category: 'Álgebra',
    desc: 'Calcula los ceros de expresiones algebraicas.',
    href: null,
  },
  {
    label: 'Calculadora de Raíz Cuadrada',
    category: 'Álgebra',
    desc: 'Calcula raíces cuadradas exactas y aproximadas.',
    href: null,
  },
];

export function EcuacionRelated() {
  return (
    <section className="bg-page py-10 lg:py-14" aria-labelledby="related-eq-heading">
      <div className="site-shell">
        <div className="mb-7">
          <p className="eyebrow">Herramientas relacionadas</p>
          <h2 id="related-eq-heading" className="mt-2 text-[1.6rem] font-bold text-ink lg:text-[1.9rem]">
