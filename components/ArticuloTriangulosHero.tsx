...
export function ArticuloTriangulosHero() {
  return (
      ...
      <div className="site-shell">
        <nav aria-label="Ruta de navegación" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/70">
            ...
            <li aria-hidden="true" className="text-white/40">/</li>
            <li className="text-white/90">Tipos de triángulos</li>
          </ol>
        </nav>
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/80">
          Los triángulos se clasifican por sus lados y por sus ángulos. Cada tipo tiene propiedades distintas y sus propias fórmulas de área y perímetro.
        </p>

        <div className="mt-5 flex flex-wrap items-center gap-4">
          <div className="flex flex-wrap gap-2">
            {['Equilátero', 'Isósceles', 'Escaleno', 'Rectángulo', 'Obtusángulo'].map(chip => (
              <span
                key={chip}
        ...
        <div className="mt-7">
          ...
          >
            Calculadora de triángulos &rarr;
          </Link>
        </div>
      </div>
    </section>
