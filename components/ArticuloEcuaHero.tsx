...
export function ArticuloEcuaHero() {
  return (
      ...
      <div className="site-shell">
        <nav aria-label="Ruta de navegación" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/70">
            ...
            <li aria-hidden="true" className="text-white/40">/</li>
            <li className="text-white/90">Cómo resolver ecuaciones</li>
          </ol>
        </nav>
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/80">
          Una ecuación es una igualdad con incógnitas. Resolverla significa encontrar el valor de esas incógnitas que hace verdadera la igualdad.
        </p>

        <div className="mt-5 flex flex-wrap items-center gap-4">
          <div className="flex flex-wrap gap-2">
            {['Ecuaciones lineales', 'Ecuaciones cuadráticas', 'Comprobación', 'Errores frecuentes'].map(chip => (
              <span
                key={chip}
