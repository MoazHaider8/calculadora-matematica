...
const calcs = [
  { href: '/calculadoras/geometria/calculadora-de-circulos', label: 'Calculadora de círculos', desc: 'Área, circunferencia y radio del círculo.' },
  { href: '/calculadoras/geometria/calculadora-de-area', label: 'Calculadora de área', desc: 'Área de todas las figuras geométricas.' },
  { href: '/calculadoras/geometria/calculadora-de-triangulos', label: 'Calculadora de triángulos', desc: 'Área y perímetro de triángulos.' },
  { href: '/calculadoras/geometria', label: 'Ver todas las calculadoras de geometría', desc: 'Círculos, triángulos, volúmenes y más.' },
];

export function CirculoRelacionadas() {
  return (
