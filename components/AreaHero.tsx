...
export function AreaHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de área online">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Área</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Calculadora de área online
        </h1>

        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Calcula el área de figuras planas como rectángulos, cuadrados, triángulos, círculos, trapecios, rombos y paralelogramos. Introduce las medidas y obtén la fórmula y el procedimiento.
        </p>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>A = b &times; h</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>A = &pi;r&sup2;</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>A = lado&sup2;</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>A = D &times; d / 2</span>
        </div>
