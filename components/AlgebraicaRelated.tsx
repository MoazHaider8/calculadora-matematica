...
const related = [
  ...
  },
  {
    ...
    category: 'Álgebra',
    desc: 'Resuelve ecuaciones lineales, cuadráticas y sistemas 2×2.',
    href: '/calculadoras/algebra/calculadora-de-ecuaciones',
  },
  {
    label: 'Calculadora de Exponentes',
    category: 'Cálculo',
    desc: 'Calcula potencias, exponentes negativos y fraccionarios.',
    href: '/calculadoras/calculo/calculadora-de-exponentes',
  },
  {
    label: 'Calculadora de Logaritmos',
    category: 'Cálculo',
    desc: 'Logaritmos en base 10, base e y bases personalizadas.',
...
export function AlgebraicaRelated() {
  return (
    <section className="bg-page py-10 lg:py-14" aria-labelledby="related-alg-heading">
      <div className="site-shell">
        <div className="mb-7">
          <p className="eyebrow">Herramientas relacionadas</p>
          <h2 id="related-alg-heading" className="mt-2 text-[1.6rem] font-bold text-ink lg:text-[1.9rem]">
