...
export function ReglaRelacionadas() {
  return (
    <section className="bg-white-soft py-8 lg:py-10" aria-labelledby="regla-rel-h">
      <div className="site-shell">
        <p className="eyebrow">Más calculadoras</p>
        <h2 id="regla-rel-h" className="mt-2 mb-5 text-[1.5rem] font-bold text-ink lg:text-[1.8rem]">
