...
const chips = ['Promedio', 'Media aritmética', 'Notas', 'Calificaciones', 'Valores'];
const stats = [
  { value: '2',    label: 'modos de cálculo'       },
  { value: '5',    label: 'ejemplos resueltos'       },
  { value: '100%', label: 'contenido en español'     },
];

export function PromedioHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de promedio online">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Promedio</li>
          </ol>
        </nav>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>10 + 8 + 9 + 7</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>34 ÷ 4</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>= 8.5</span>
        </div>
