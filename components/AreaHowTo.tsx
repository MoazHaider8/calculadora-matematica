const steps = [
  { n: '1', text: 'Elige la figura geométrica que quieres calcular.' },
  { n: '2', text: 'Introduce las medidas solicitadas: base, altura, lado, radio o diagonales.' },
  { n: '3', text: 'Selecciona la unidad si quieres mostrar cm², m² u otra.' },
  { n: '4', text: 'Pulsa calcular área.' },
  { n: '5', text: 'Revisa la fórmula, el procedimiento y el resultado.' },
];

export function AreaHowTo() {
  return (
    <section className="bg-white py-12 lg:py-16" aria-labelledby="howto-area-heading">
      <div className="site-shell">
        <p className="eyebrow">Guía de uso</p>
        <h2 id="howto-area-heading" className="mt-2 mb-8 text-[1.5rem] font-bold text-ink lg:text-[1.8rem]">
          Cómo usar la calculadora de área
        </h2>
