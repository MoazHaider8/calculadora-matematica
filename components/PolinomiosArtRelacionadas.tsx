...
const calcs = [
  { href: '/calculadoras/algebra/calculadora-de-polinomios', label: 'Calculadora de polinomios', desc: 'Suma, resta y multiplica polinomios.' },
  { href: '/calculadoras/algebra/calculadora-de-ecuaciones', label: 'Calculadora de ecuaciones', desc: 'Resuelve ecuaciones de cualquier grado.' },
  { href: '/calculadoras/algebra/calculadora-algebraica', label: 'Calculadora algebraica', desc: 'Simplifica y factoriza expresiones.' },
  { href: '/calculadoras/algebra', label: 'Ver todas las calculadoras de álgebra', desc: 'Ecuaciones, polinomios, raíces y más.' },
];

export function PolinomiosArtRelacionadas() {
  return (
