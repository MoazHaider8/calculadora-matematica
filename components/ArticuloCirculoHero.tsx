...
export function ArticuloCirculoHero() {
  return (
      ...
      <div className="site-shell">
        <nav aria-label="Ruta de navegación" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/70">
            ...
            <li aria-hidden="true" className="text-white/40">/</li>
            <li className="text-white/90">Área y circunferencia del círculo</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-2 text-[1.85rem] font-extrabold leading-tight text-white lg:text-[2.4rem]">
          Cómo calcular área y circunferencia de un círculo
        </h1>

        <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/80">
          El área y la circunferencia del círculo dependen del radio. Con las fórmulas correctas y el valor de π, los cálculos son directos.
        </p>

        <div className="mt-5 flex flex-wrap items-center gap-4">
          <div className="flex flex-wrap gap-2">
            {['Radio y diámetro', 'Área del círculo', 'Perímetro o circunferencia', 'Valor de π'].map(chip => (
              <span
                key={chip}
