...
const chips = ['Cubo', 'Prisma', 'Cilindro', 'Cono', 'Esfera'];
const stats = [
  { value: '7',    label: 'cuerpos'             },
  { value: '5',    label: 'ejemplos resueltos'  },
  { value: '100%', label: 'contenido en español' },
];

export function VolumenHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de volumen online">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Volumen</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Calculadora de volumen online
        </h1>

        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Calcula el volumen de cuerpos geométricos como cubos, prismas, cilindros, conos, esferas y pirámides. Introduce las medidas y obtén la fórmula, las unidades cúbicas y el procedimiento.
        </p>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>V = l &times; w &times; h</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>V = &pi;r&sup2;h</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>V = 4/3 &pi;r&sup3;</span>
        </div>
