...
const chips = ['Radio', 'Diámetro', 'Área', 'Circunferencia', 'π'];
const stats = [
  { value: '4',    label: 'formas de entrada'    },
...
export function CirculosHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de círculos online">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Círculos</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Calculadora de círculos online
        </h1>

        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Calcula radio, diámetro, área y circunferencia de un círculo a partir de un valor conocido, con fórmula y procedimiento paso a paso.
        </p>
        ...
        >
          ...
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>d = 2r</span>
        </div>
