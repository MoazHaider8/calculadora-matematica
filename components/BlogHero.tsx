...
const chips = ['Fórmulas', 'Ejemplos', 'Guías', 'Pasos', 'Calculadoras relacionadas'];
const stats = [
  { value: '6',   label: 'áreas matemáticas'  },
  { value: '10',  label: 'guías iniciales'     },
  { value: '100%', label: 'contenido en español' },
];

export function BlogHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Blog de matemáticas">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li style={{ color: '#DDF3F0' }}>Blog</li>
          </ol>
        </nav>

        <p className="eyebrow" style={{ color: '#D8A31A' }}>Recursos de aprendizaje</p>
        ...
        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Este blog publica guías, fórmulas, ejemplos y explicaciones paso a paso para ayudarte a entender conceptos matemáticos antes o después de usar las calculadoras.
        </p>

        <p className="mt-3 max-w-xl text-sm font-semibold" style={{ color: 'rgba(216,163,26,0.9)' }}>
          Las guías explican conceptos y fórmulas; las calculadoras realizan el cálculo.
        </p>
