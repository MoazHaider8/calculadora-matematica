...
const quickLinks = [
  { label: 'Ecuaciones',    anchor: '#herramienta-ecuaciones'  },
  { label: 'Polinomios',    anchor: '#herramienta-polinomios'  },
  { label: 'Raíces',        anchor: '#herramienta-raices'      },
  { label: 'Álgebra básica', anchor: '#herramienta-algebraica' },
  { label: 'Raíz cuadrada', anchor: '#herramienta-raiz-cuadrada' },
];
...
export function AlgebraHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Álgebra">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Álgebra</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Calculadoras de álgebra organizadas por tema
        </h1>

        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Esta categoría reúne herramientas para trabajar con ecuaciones, expresiones algebraicas, polinomios, raíces y operaciones simbólicas.
        </p>

        {/* Algebra identity strip */}
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>2x + 3 = 7</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>x² + 3x + 2</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>√25 = 5</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>x³ - 2x² + x</span>
        </div>
