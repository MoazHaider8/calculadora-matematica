...
const chips = ['Suma', 'Producto punto', 'Producto cruz', 'Norma', 'Ángulo'];

const stats = [
  { value: '7',    label: 'operaciones'          },
...
export function VectorHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Calculadora de vectores">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Calculadora de Vectores</li>
          </ol>
        </nav>
