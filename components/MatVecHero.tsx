...
const quickLinks = [
  { label: 'Matrices',      anchor: '#herramienta-matrices'                },
  { label: 'Determinantes', anchor: '#herramienta-determinantes'           },
  { label: 'Vectores',      anchor: '#herramienta-vectores'                },
  { label: 'Sistemas',      anchor: '#herramienta-sistemas-de-ecuaciones'  },
  { label: 'Matriz inversa', anchor: '#herramienta-matriz-inversa'         },
];
...
export function MatVecHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Matrices y vectores">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Matrices y Vectores</li>
          </ol>
        </nav>
        ...
        <h1 className="mt-3 max-w-2xl text-[1.9rem] font-bold leading-tight text-white sm:text-[2.4rem] lg:text-[2.8rem]">
          Calculadoras de matrices y vectores
        </h1>

        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Esta categoría reúne herramientas para trabajar con matrices, vectores, determinantes, sistemas lineales e inversas de matrices.
        </p>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>A &middot; B</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>det(A)</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>A&#x207B;&#xB9;</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>u &middot; v</span>
          <span style={{ color: 'rgba(221,243,240,0.25)' }}>·</span>
          <span style={{ color: 'rgba(216,163,26,0.85)' }}>Ax = b</span>
        </div>
