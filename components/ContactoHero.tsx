...
const chips = ['Reportar error', 'Sugerir calculadora', 'Comentarios', 'Consultas generales', 'Mejoras del sitio'];
const stats = [
  { value: 'Formulario', label: 'claro'              },
  { value: 'Usuarios',   label: 'con comentarios'    },
  { value: '100%',       label: 'contenido en español' },
];

export function ContactoHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Contacto">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li style={{ color: '#DDF3F0' }}>Contacto</li>
          </ol>
        </nav>

        <p className="eyebrow" style={{ color: '#D8A31A' }}>Contacto</p>
        ...
        <p className="mt-4 max-w-xl text-base leading-relaxed" style={{ color: '#DDF3F0' }}>
          Puedes usar esta página para reportar un error en una calculadora, sugerir una nueva herramienta, enviar comentarios sobre el sitio o hacer una consulta general. Usa el formulario de abajo para escribirnos.
        </p>
