...
export function ArticuloExpHero() {
  return (
      ...
      <div className="site-shell">
        <nav aria-label="Ruta de navegación" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/70">
            ...
            <li aria-hidden="true" className="text-white/40">/</li>
            <li className="text-white/90">Reglas de exponentes</li>
          </ol>
        </nav>
        ...
        <div className="mt-5 flex flex-wrap items-center gap-4">
          <div className="flex flex-wrap gap-2">
            {['Exponente cero', 'Exponente negativo', 'Potencia de potencia', 'Exponente fraccionario'].map(chip => (
              <span
                key={chip}
        ...
        <div className="mt-7">
          ...
          >
            Calculadora de exponentes &rarr;
          </Link>
        </div>
      </div>
    </section>
