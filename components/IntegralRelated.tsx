...
// Only /calculadoras/calculo exists. Individual tool pages are Próximamente.
const related = [
  {
    label: 'Calculadora de Derivadas',
    category: 'Cálculo',
    desc: 'Calcula la derivada de una función respecto a una variable. Operación inversa a la integración.',
    href: '/calculadoras/calculo/calculadora-de-derivadas',
  },
  {
    label: 'Calculadora de Límites',
    category: 'Cálculo',
    desc: 'Analiza el valor al que se aproxima una función cuando su variable tiende a un punto o al infinito.',
...
export function IntegralRelated() {
  return (
    <section className="bg-page py-10 lg:py-14" aria-labelledby="related-heading">
      <div className="site-shell">

        <div className="mb-7">
          <p className="eyebrow">Herramientas relacionadas</p>
          <h2 id="related-heading" className="mt-2 text-[1.6rem] font-bold text-ink lg:text-[1.9rem]">
