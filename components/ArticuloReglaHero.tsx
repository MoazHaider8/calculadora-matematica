...
const chips = ['Directa', 'Inversa', 'Fórmula', 'Ejemplos', 'Errores comunes'];

export function ArticuloReglaHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Qué es la regla de tres y cómo usarla">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Qué es la regla de tres</li>
          </ol>
        </nav>
        ...
        <div className="mt-5 flex flex-wrap items-center gap-5">
          <span className="text-xs font-semibold" style={{ color: 'rgba(221,243,240,0.55)' }}>
            Tiempo de lectura: <span className="font-bold" style={{ color: '#DDF3F0' }}>5 minutos</span>
          </span>
          <span className="text-xs font-semibold" style={{ color: 'rgba(221,243,240,0.55)' }}>
        ...
        <div className="mt-7">
          ...
          >
            Usar calculadora de regla de tres &rarr;
          </Link>
        </div>
