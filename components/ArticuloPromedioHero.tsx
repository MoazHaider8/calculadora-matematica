...
const chips = ['Fórmula', 'Promedio simple', 'Ponderado', 'Notas', 'Errores comunes'];

export function ArticuloPromedioHero() {
  return (
    <section className="relative overflow-hidden bg-ocean" aria-label="Cómo sacar promedio paso a paso">
      ...
      <div className="site-shell relative py-10 lg:py-14">
        ...
        <nav aria-label="Migas de pan" className="mb-6">
          <ol className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <li aria-hidden="true" style={{ color: 'rgba(221,243,240,0.35)' }}>&rsaquo;</li>
            <li style={{ color: '#DDF3F0' }}>Cómo sacar promedio</li>
          </ol>
        </nav>
        ...
        <div className="mt-7">
          <Link href="/calculadoras/aritmetica/calculadora-de-promedio" className="inline-flex items-center gap-2 rounded-lg bg-white px-5 py-2.5 text-sm font-bold text-ink transition-colors hover:bg-gold">
            Usar calculadora de promedio &rarr;
          </Link>
        </div>
      </div>
    </section>
