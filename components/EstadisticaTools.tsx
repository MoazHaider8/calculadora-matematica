const tools = [
  {
    ...
    explanation: 'Calcula la media aritmética de un conjunto de datos. Muestra la suma total, el número de valores y el procedimiento paso a paso.',
    useCase:     'Para obtener el valor representativo de un conjunto de datos numéricos.',
    url:         null,
  },
  {
    id:          'mediana',
    symbol:      'Me',
    mathPreview: 'valor central',
    name:        'Calculadora de Mediana',
    explanation: 'Encuentra el valor central de una lista de datos ordenados. Útil cuando los valores extremos distorsionan la media.',
    useCase:     'Para encontrar el valor central cuando hay valores muy altos o muy bajos en la lista.',
    url:         null,
  },
  {
    id:          'moda',
    symbol:      'Mo',
    mathPreview: 'valor más repetido',
    name:        'Calculadora de Moda',
    explanation: 'Identifica el valor o valores que aparecen con mayor frecuencia en un conjunto de datos.',
    useCase:     'Para saber qué valor se repite más en una muestra o encuesta.',
    url:         null,
  },
  {
    id:          'varianza',
    ...
    explanation: 'Mide cuánto se dispersan los valores respecto a la media. Un valor alto indica mayor dispersión.',
    useCase:     'Para analizar la dispersión de datos en ciencias, economía o control de calidad.',
    url:         null,
  },
  {
    ...
    explanation: 'Calcula la raíz cuadrada de la varianza. Expresa la dispersión en las mismas unidades que los datos originales.',
    useCase:     'Para interpretar la dispersión de datos en unidades comprensibles y comparables.',
    url:         null,
  },
];
